...
import 'package:sedad_bank/core/services/api_service.dart';
import 'package:sedad_bank/providers/kyc_provider.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (ctx) => KycProvider(ApiService())),
      ],
