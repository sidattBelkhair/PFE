...
import '../screens/kyc/kyc_select_document_screen.dart';
import '../screens/kyc/kyc_scan_recto_screen.dart';
import '../screens/kyc/kyc_confirm_info_screen.dart';
import '../screens/kyc/kyc_face_verify_screen.dart';
import '../screens/kyc/kyc_success_screen.dart';
import '../screens/kyc/kyc_debug_screen.dart';
import '../screens/kyc/kyc_result_screen.dart';
...
class AppRoutes {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/kyc/select-document', builder: (_, __) => const KycSelectDocumentScreen()),
      GoRoute(path: '/kyc/scan-recto',      builder: (_, __) => const KycScanRectoScreen()),
      GoRoute(path: '/kyc/confirm-info',    builder: (_, __) => const KycConfirmInfoScreen()),
      GoRoute(path: '/kyc/face-verify',     builder: (_, __) => const KycFaceVerifyScreen()),
      GoRoute(path: '/kyc/success',         builder: (_, __) => const KycSuccessScreen()),
      GoRoute(path: '/kyc/debug',           builder: (_, __) => const KycDebugScreen()),
      GoRoute(path: '/kyc/result',          builder: (_, __) => const KycResultScreen()),
    ],
  );
}
